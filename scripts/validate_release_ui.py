...
required = {
    ...
    "release_skin": (
        ...
        'Resources.Load<Sprite>(Root + name)',
        "public static Sprite GlassPanel",
        "public static Sprite GameplayPanel",
        "public static Sprite RoutePanel",
        "public static Sprite NavViolet",
        "public static Sprite PrimaryButton",
        "public static Sprite SecondaryButton",
        "public static Sprite ScoreRing",
        "HasCoreSkin",
    ),
    "tutorial_intro": (
        "TutorialIntroCanvas",
    ...
    "campaign": (
        ...
        '"LevelNumber", levelNumber.ToString(), 43',
        '"NodeFace"',
        '"StateBadge"',
