...
- [ ] Production integration использует официальный Remote Config package версии, повторно проверенной перед release; текущий проверенный Unity target — **10.5.1** (актуальная версия, повторно сверена 2026-09-18).
